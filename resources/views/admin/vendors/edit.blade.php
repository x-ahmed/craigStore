                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4
                                    class="card-title"
                                    id="basic-layout-form">تعديل المتجر</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form
                                        class="form"
                                        action="{{route('admin.vendor.update', $vend->id)}}"
                                        method="post"
                                        ...
                                        <div class="form-body">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            ...
                                                            <option value="">اختر قسم المتجر...</option>

                                                                @if (isset($cates) && $cates->count() > 0)

                                                                    @foreach ($cates as $cate)
                                                                        <option
                                                                            @if ($cate->id === $vend->cate_id)
                                                                                selected
                                                                            @endif
                                                                            value="{{$cate->id}}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <label for="vend-show-addr">العنوان الحالي</label>
                                                        <input
                                                            type="text"
                                                        ...
                                                        @error('vend-show-addr')
                                                            <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group text-center" style="{{--margin-top: 37px;--}}">
                                                        <label
                                                        ...
                                                        <input
                                                            ...
                                                            class="switchery"
                                                            data-color="success"
                                                            @if (old('status', $vend->status) == 1) checked @endif />
