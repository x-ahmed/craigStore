              ...
              <ul
                     ...
                     <li class="nav-item">
                            <a href="">
                                   ...
                                   <span
                                          class="menu-title"
                                          data-i18n="nav.dash.main">لغات الموقع</span>
                            ...
                            <ul class="menu-content">
                                   <li class="active">
                                          <a
                                                 ...
                                                 data-i18n="nav.dash.ecommerce">عرض كل اللغات</a>
                                   </li>
                                   <li>
                                          <a
                                                 class="menu-item"
                     ...
                     <li class="nav-item">
                            <a href="">
                                   ...
                                   <span
                                          class="menu-title"
                                          data-i18n="nav.dash.main">الطلاب  </span>
                                   <span
                            ...
                            <ul class="menu-content">
                                   ...
                                   <li>
                                          <a
                                                 class="menu-item"
                                                 href=""
                                                 data-i18n="nav.dash.crypto">أضافة طالب </a>
                                   </li>
                            </ul>
                     </li>
                     ...
                     <li class=" nav-item">
                            <a href="#">
                                   ...
                                   <span
                                          class="menu-title"
                                          data-i18n="nav.templates.main">Templates</span>
                            </a>
                            <ul class="menu-content">
                                   <li>
                                          <a
                                          ...
                                          <ul class="menu-content">
                                                 ...
                                                 <li>
                                                        <a
                                                               class="menu-item"
                                                               href="../vertical-modern-menu-template">Modern Menu</a>
                                                 </li>
                                                 <li>
                                                        <a
                                                               class="menu-item"
